    ...
    Route::middleware('auth:sanctum', 'throttle:global')->group(function () {
        ...
        Route::middleware('verified')->group(function () {
            ...
            Route::middleware('role:admin')->group(function () {
                ...
                // PERBAIKAN: Hapus "except" agar Admin bisa LIHAT (Index/Show) dan EDIT
            ...
            // --- PUBLIC READ (Opsional: Agar user biasa bisa lihat list dokter) ---
            // Disimpan di bawah agar Route Admin (di atas) diprioritaskan untuk Admin
